...
\COPY products FROM 'home/ubuntu/seed/product.csv' delimiter ',' csv header;
...
\COPY reviews FROM 'home/ubuntu/seed/reviews.csv' delimiter ',' csv header;
...
\COPY characteristics FROM 'home/ubuntu/seed/characteristics.csv' delimiter ',' csv header;
...
\COPY photos FROM 'home/ubuntu/seed/reviews_photos.csv' delimiter ',' csv header;
...
\COPY characteristic_reviews FROM 'home/ubuntu/seed/characteristic_reviews.csv' delimiter ',' csv header;
